...
$(function() {
	...
	$('#order_measure').iziModal({
		title: 'Заказать мастера для замеров',
    	subtitle: 'мы перезвоним вам в течении 1 часа',
		headerColor: '#ffd32a',
		background: '#1e1e1e',
	});

	$('.slideshow__owl-carousel').owlCarousel({
	    loop: true,
	    autoplay: true,
	...
	$('.popup-gallery').magnificPopup({
		...
		image: {
			...
			titleSrc: function(item) {
				return item.el.attr('title') + '<small>Remont-stroyka-4you.ru</small>';
			}
		}
	});

	$('.our-object__carousel').owlCarousel({
	    loop: true,
        dots: false,
        margin: 30,
        nav: true,
